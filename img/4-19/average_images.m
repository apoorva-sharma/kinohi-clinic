...
% Rescale to 0 to 1023
SampleFinal_Scaled = SampleFinal - min(min(SampleFinal));
SampleFinal_Scaled = (1023 / max(max(SampleFinal_Scaled)))*SampleFinal_Scaled;
...
imwrite(uint8(SampleFinal_Trimmed_Scaled),'Output.png');

save output SampleFinal_Trimmed_Scaled
imagesc(SampleFinal_Trimmed_Scaled); 
colormap 'gray'
